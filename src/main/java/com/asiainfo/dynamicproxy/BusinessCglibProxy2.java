 ...
 */
//传入业务类实例作为目标对象。
//适用于业务类对象的状态在构造器初始化后会被改变的业务类
public class BusinessCglibProxy2 implements MethodInterceptor {
	//拦截器持有真正的业务对象
	private Object target;
	
	private BusinessCglibProxy2(Object target) {
		//保存业务对象
		this.target = target;
	}
	...
	public static Object getCglibProxy(Object target) {
		...
		//设置需要织入的逻辑
		enhancer.setCallback(new BusinessCglibProxy2(target));  
		// 创建代理对象  //使用织入器创建子类
	...
	//创建带参数的代理对象 
	public static Object getCglibProxy(Object target, Class<?>[] argClazz, Object[] args) {
	...
	public Object intercept(Object obj, Method method, Object[] args,
		...
		//那么proxy.invoke(Object obj, Object[] args)方法是做什么的，
		//javadoc上说这个方法可以用于 相同类中的其他对象的方法执行，
	...
	public static void main(String[] args) {
		...
		BusinessImpl proxy = (BusinessImpl) BusinessCglibProxy2.getCglibProxy(new BusinessImpl());
		proxy.service();
		
		//带参数的业务类
		BusinessImpl proxy1 = (BusinessImpl) BusinessCglibProxy2.getCglibProxy(new BusinessImpl("jaesonchen"), new Class[] {String.class}, new Object[] {"jaesonchen"});
		proxy1.service();
	}
}
