...
![read-uncommitted](picture/read-uncommitted.jpg)  

#### 避免脏读(读已提交)

![read-committed](picture/read-committed.jpg)  

#### 不可重复读

还是刚才上面的读已提交的图，虽然避免了读未提交，但是却出现了，一个事务还没有结束，就发生了 不可重复读问题。

![unrepeatable-read](picture/unrepeatable-read.jpg)  

#### 可重复读

![repeatable-read](picture/repeatable-read.jpg)  

#### 防止幻读(可重复读)

![serializable](picture/serializable.jpg) 
