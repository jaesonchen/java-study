# 硬件架构 
![cpu](../../../../resources/images/jmm/cpu-memory.png)  
...
java8开始提供官方的字节填充解决方案  @sun.misc.Contended，无需担心 jdk 的无效字段优化，无需担心 Cache Line 在不同 CPU 下的大小究竟是不是 64 字节。使用 @Contended 注解可以完美的避免伪共享问题。
...
![reorder](../../../../resources/images/jmm/reorder.jpg)    
...
![write-cache](../../../../resources/images/jmm/write-cache.jpg)  
