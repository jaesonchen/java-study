 ...
 */
public class Percent2DoubleParseServiceImpl implements ParseService<Double> {
	...
	public Double parse(String str) {
		...
		try {
			...
			throw new ParseException(ErrorCodes.RECORD_RESULTCODE_ERROR_TYPE, "除了(%)不能包含非数字字符");
		}
	}
	/* 
	 * @Description: TODO
