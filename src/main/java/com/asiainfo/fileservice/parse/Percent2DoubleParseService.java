 ...
 */
public class Percent2DoubleParseService implements IopParseService<Double> {

	private IopParseService<?> delegate = null;
	private int fraction = 2;
	
	public Percent2DoubleParseService() {}
	public Percent2DoubleParseService(int fraction) {
