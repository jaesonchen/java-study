...
public class ReadonlyDemo {
	...
	public static void main(String[] args) {
		...
		//3. Arrays.asList 返回的是固定大小的list，可以get、set，可以迭代，不能add、remove
		...
		//4. List.subList 返回的子list 不再是Serializable，rpc应用中需要转换为ArrayList
		List<String> list3 = list2.subList(0, 2);
		System.out.println(list3 instanceof Serializable);
		// ArrayList.subList() 只是返回列表的一个视图，不会新建列表，对子列表的修改将影响到父列表。
