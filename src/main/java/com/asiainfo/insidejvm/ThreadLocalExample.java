 ...
 * Thread类里包含成员变量ThreadLocal.ThreadLocalMap threadLocals = null;
 * 用于保存每个线程的ThreadLocal变量。
 * 在Thread的private void exit() 方法里设置threadLocals = null;
 * 用于线程完成时自动清空ThreadLocal变量。
