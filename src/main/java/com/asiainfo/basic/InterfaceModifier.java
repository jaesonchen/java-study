...
public class InterfaceModifier {
    ...
    // 类内部的成员接口可以拥有与field一样的modifier，public/protected/private/abstract/static (final除外)
    protected static abstract interface InnerInterface1 {}
}
...
interface OuterInterface {
    ...
    // 接口内的method，要么是public/abstract，要么是拥有实现体的default/static
    void m1();
